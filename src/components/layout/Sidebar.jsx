          ...
          <div>
            <button
              ...
              className={`w-full flex items-center ${sidebarCollapsed ? "justify-center" : "justify-between"
                } px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 group ${active
                  ? "bg-[#26A7E2] dark:bg-[#26A7E2] text-white dark:text-primary-300"
                  : "text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white"
                }`}
            >
              <div className="flex items-center">
                <div
                  className={`flex items-center justify-center w-5 h-5 ${sidebarCollapsed ? "" : "mr-3"
                    } flex-shrink-0`}
                >
              ...
              <div className="ml-8 mt-1 space-y-1 fade-in">
                {item.children.map((child) => (
                  <Link
                    ...
                    className={`block px-4 py-2 text-sm rounded-lg transition-all duration-200 truncate ${isActive(child.path)
                        ? "bg-[#26A7E2] dark:bg-primary-900/10 text-white dark:text-primary-300 border-l-2 border-primary-500"
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-6 h-20 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
          <div
            className={`w-full flex items-center ${sidebarCollapsed ? "justify-center w-full" : ""
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
          ...
          >
            <div className="w-8 h-8 bg-[#26A7E2] rounded-full flex items-center justify-center flex-shrink-0">
            ...
            {!sidebarCollapsed && (
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-[#26A7E2]">
                  <a href="http://codecleanpros.com/" target="_blank">
                    Code Clean Pros - Live
                  </a>
                </p>
              </div>
            )}
