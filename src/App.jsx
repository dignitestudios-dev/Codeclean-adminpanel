                    ...
                    <ProtectedRoute>
                      <Layout>
                        <Routes>
                          ...
                          <Route path="/approval-requests" element={<Userrequestdetail />} />

                          <Route path="/withdrawal-details" element={<WithdrawalDetails />} />

                          <Route path="user-details/:uid" element={<Userdetails />} />
                          <Route path="serviceprovider-details/:uid" element={<Serviceproviderdetailpage />} />
                          ...
                          <Route path="/posts">
                            <Route path="" element={<AnonymousPosts />} />
